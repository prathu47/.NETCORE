...
namespace firstMVC.Controllers
{
    public class TraineesController : Controller
    {
        ...
        private readonly EvryindiaContext _context;

        public TraineesController(ILogger<TraineesController> logger, IToastNotification toastNotification, EvryindiaContext context)
        {
            _logger = logger;
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'EvryindiaContext.Trainees'  is null.");
            }
            var trainee = await _context.Trainees.FindAsync(id);
            if (trainee != null)
            {
